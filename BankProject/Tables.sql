...
create table Customer(SSN varchar(9) unique,
...
create table Account(Acct_Id int identity(1,1) Primary Key,
...
create table Transactions(Cust_Id int foreign key references Customer(Cust_Id),
						 Amount decimal(18,2),
